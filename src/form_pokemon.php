    ...
    <main class="container mt-5">
        <div class="card shadow-lg">
            ...
            <div class="card-body p-4">
                <form action="salvar_pokemon.php" method="POST">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            <label for="tipo_secundario_id" class="form-label">Tipo Secundário (Opcional)</label>
                            <select class="form-select" name="tipo_secundario_id" id="tipo_secundario_id">
                                ...
                                <?php foreach ($tipos as $tipo): ?>
                                    <option value="<?= $tipo['id'] ?>" <?= ($tipo['id'] == $pokemon['tipo_secundario_id']) ? 'selected' : '' ?>>
                                        <?= $tipo['icone'] ?> <?= htmlspecialchars($tipo['nome']) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    ...
                    <h5 class="mb-3">Imagens (URLs)</h5>
                    <div class="row g-3 mb-4">
                        <div class="col-md-4">
                            <label for="imagem_padrao" class="form-label">Imagem Padrão</label>
                            <input type="text" class="form-control" name="imagem_padrao" id="imagem_padrao" value="<?= htmlspecialchars($pokemon['imagem_padrao']) ?>" placeholder="http://...">
                        </div>
                    </div>
                    ...
                    <div class="row g-2 mb-4">
                        ...
                        <div class="col-md-2 col-4">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="fraqueza_<?= $tipo['id'] ?>">
